...
Configures Alembic to work with DeerTeamX's async SQLAlchemy setup.
"""
...
# Import DeerTeamX models for autogenerate support
...
def run_migrations_online() -> None:
    ...
    For async databases, we need to use asyncio to run the migrations.
    """
